    ...
    <div class="col-md-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
          ...
          <h3 class="panel-title text-center">pesan</h3>
</div>
...
<br>
<div class="input-group">
  <span class="input-group-addon">Jumlah tiket </span>
...
<div class="col-lg-2">
    <div class="input-group">
      ...
      <input type="text" class="form-control" placeholder="16.00-18.00">
    </div>
  </div>
  <div class="col-lg-2">
    <div class="input-group">
      ...
      <input type="text" class="form-control" placeholder="18.00-20.00">
    </div>
  </div>
  <div class="col-lg-2">
    <div class="input-group">
      ...
      <input type="text" class="form-control" placeholder="20.00-22.00">
    </div>
  </div>

 <li><a href=""><button type="button" class="btn btn-danger">PESAN</button></a></li>
         </div>
      </div>
    </div>
  </div>
