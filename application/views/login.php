...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=base_url();?>index2.html"><b>LOGIN</b>Bioskop</a>
  </div>
  <!-- /.login-logo -->
...
<?php endif?>
    <form action="<?=base_url('index.php/user/masuk');?>" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <input name="cek" type="hidden" value="1">
        <div class="col-xs-4">
    ...
    <a href="<?=base_url('index.php/user/daftar')?>" class="text-center">Register a new membership</a>
